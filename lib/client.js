window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\leyang809\Desktop\工作区\ocgo-build\src\client\ocgo.module.css.mjs
		const css = ".o0YzEG_wrap{z-index:50;user-select:none;display:inline-flex;position:absolute;bottom:calc(100% - 1px);left:-9px}.o0YzEG_segOk{color:var(--dsh-color-success,#3fb950)}.o0YzEG_chip{background:var(--dsh-color-surface,transparent);height:22px;color:var(--dsh-color-text,inherit);cursor:grab;white-space:nowrap;user-select:none;border:0;border-radius:999px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:1;display:inline-flex}.o0YzEG_chip:hover,.o0YzEG_chipOpen{border-color:var(--dsh-color-accent,#50a0ffb3)}.o0YzEG_lockBtn{cursor:pointer;color:var(--dsh-color-accent,#50a0ffe6);white-space:nowrap;background:0 0;border:0;align-items:center;margin-left:4px;padding:0 2px;font-size:11px;line-height:1;display:inline-flex}.o0YzEG_iconBtns{align-items:center;gap:2px;display:inline-flex}.o0YzEG_iconBtns .o0YzEG_lockBtn{margin-left:0}.o0YzEG_chipCol{border-radius:10px;flex-direction:column;align-items:flex-start;gap:3px;height:auto;padding:5px 8px}.o0YzEG_colHead{align-items:center;gap:8px;display:flex}.o0YzEG_colFoot{justify-content:space-between;align-items:center;gap:8px;width:100%;display:flex}.o0YzEG_colFoot .o0YzEG_iconBtns{margin-left:auto}.o0YzEG_seg{align-items:baseline;gap:3px;display:inline-flex}.o0YzEG_segSep{opacity:.45}.o0YzEG_segWarn{color:var(--dsh-color-warning,#d29922)}.o0YzEG_segErr{color:var(--dsh-color-danger,#e5534b)}.o0YzEG_details{z-index:40;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface-elevated,#1f1f1f);min-width:220px;color:var(--dsh-color-text,inherit);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;font-size:12px;display:flex;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%);box-shadow:0 4px 12px #0000004d}.o0YzEG_window{justify-content:space-between;align-items:center;gap:12px;display:flex}.o0YzEG_windowLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.9;align-items:center;gap:6px;display:inline-flex}.o0YzEG_windowValue{font-variant-numeric:tabular-nums;align-items:baseline;gap:6px;display:inline-flex}.o0YzEG_windowReset{opacity:.65;font-variant-numeric:tabular-nums;font-size:11px}.o0YzEG_foot{border-top:1px solid var(--dsh-color-border,#80808040);justify-content:space-between;align-items:center;gap:8px;padding-top:6px;font-size:11px;display:flex}.o0YzEG_footRight{align-items:center;gap:8px;margin-left:auto;display:inline-flex}.o0YzEG_setBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;text-transform:lowercase;background:0 0;border:0;padding:0;font-size:11px}.o0YzEG_setBtn:hover{text-decoration:underline}.o0YzEG_fetchedAt{opacity:.6}.o0YzEG_refreshBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.o0YzEG_refreshBtn:hover{text-decoration:underline}.o0YzEG_setPanel{flex-direction:column;gap:8px;min-width:260px;display:flex}.o0YzEG_field{flex-direction:column;gap:3px;display:flex}.o0YzEG_fieldLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.75;font-variant-numeric:tabular-nums;font-size:11px}.o0YzEG_fieldInput{box-sizing:border-box;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);width:100%;color:var(--dsh-color-text,inherit);font-variant-numeric:tabular-nums;border-radius:6px;outline:none;height:26px;padding:0 8px;font-size:12px}.o0YzEG_fieldInput:focus{border-color:var(--dsh-color-accent,#50a0ffb3)}.o0YzEG_setHint{opacity:.55;font-size:11px}.o0YzEG_errorText{color:var(--dsh-color-danger,#e5534b);white-space:normal;max-width:240px;font-size:11px}";
		...
		var ocgo_module_css_default = {
			"chip": "o0YzEG_chip",
			"chipCol": "o0YzEG_chipCol",
			"chipOpen": "o0YzEG_chipOpen",
			"colFoot": "o0YzEG_colFoot",
			"colHead": "o0YzEG_colHead",
			"details": "o0YzEG_details",
			"errorText": "o0YzEG_errorText",
			"fetchedAt": "o0YzEG_fetchedAt",
			"field": "o0YzEG_field",
			"fieldInput": "o0YzEG_fieldInput",
			"fieldLabel": "o0YzEG_fieldLabel",
			"foot": "o0YzEG_foot",
			"footRight": "o0YzEG_footRight",
			"iconBtns": "o0YzEG_iconBtns",
			"lockBtn": "o0YzEG_lockBtn",
			"refreshBtn": "o0YzEG_refreshBtn",
			"seg": "o0YzEG_seg",
			"segErr": "o0YzEG_segErr",
			"segOk": "o0YzEG_segOk",
			"segSep": "o0YzEG_segSep",
			"segWarn": "o0YzEG_segWarn",
			"setBtn": "o0YzEG_setBtn",
			"setHint": "o0YzEG_setHint",
			"setPanel": "o0YzEG_setPanel",
			"window": "o0YzEG_window",
			"windowLabel": "o0YzEG_windowLabel",
			"windowReset": "o0YzEG_windowReset",
			"windowValue": "o0YzEG_windowValue",
			"wrap": "o0YzEG_wrap"
		};
		//#endregion
