window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\leyang809\Desktop\工作区\ocgo-build2\src\client\ocgo.module.css.mjs
		const css = ".FYW2ia_wrap{z-index:50;user-select:none;display:inline-flex;position:absolute;bottom:calc(100% - 1px);left:-9px}.FYW2ia_segOk{color:var(--dsh-color-success,#3fb950)}.FYW2ia_chip{background:var(--dsh-color-surface,transparent);height:22px;color:var(--dsh-color-text,inherit);cursor:grab;white-space:nowrap;user-select:none;border:0;border-radius:999px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:1;display:inline-flex}.FYW2ia_chip:hover,.FYW2ia_chipOpen{border-color:var(--dsh-color-accent,#50a0ffb3)}.FYW2ia_lockBtn{cursor:pointer;color:var(--dsh-color-accent,#50a0ffe6);white-space:nowrap;background:0 0;border:0;align-items:center;margin-left:4px;padding:0 2px;font-size:11px;line-height:1;display:inline-flex}.FYW2ia_iconBtns{align-items:center;gap:2px;display:inline-flex}.FYW2ia_iconBtns .FYW2ia_lockBtn{margin-left:0}.FYW2ia_chipCol{border-radius:10px;flex-direction:column;align-items:flex-start;gap:3px;height:auto;padding:5px 8px}.FYW2ia_colHead{align-items:center;gap:8px;display:flex}.FYW2ia_colFoot{justify-content:space-between;align-items:center;gap:8px;width:100%;display:flex}.FYW2ia_colFoot .FYW2ia_iconBtns{margin-left:auto}.FYW2ia_seg{align-items:baseline;gap:3px;display:inline-flex}.FYW2ia_segSep{opacity:.45}.FYW2ia_segWarn{color:var(--dsh-color-warning,#d29922)}.FYW2ia_segErr{color:var(--dsh-color-danger,#e5534b)}.FYW2ia_details{z-index:40;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface-elevated,#1f1f1f);min-width:220px;color:var(--dsh-color-text,inherit);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;font-size:12px;display:flex;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%);box-shadow:0 4px 12px #0000004d}.FYW2ia_window{justify-content:space-between;align-items:center;gap:12px;display:flex}.FYW2ia_windowLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.9;align-items:center;gap:6px;display:inline-flex}.FYW2ia_windowValue{font-variant-numeric:tabular-nums;align-items:baseline;gap:6px;display:inline-flex}.FYW2ia_windowReset{opacity:.65;font-variant-numeric:tabular-nums;font-size:11px}.FYW2ia_foot{border-top:1px solid var(--dsh-color-border,#80808040);justify-content:space-between;align-items:center;gap:8px;padding-top:6px;font-size:11px;display:flex}.FYW2ia_footRight{align-items:center;gap:8px;margin-left:auto;display:inline-flex}.FYW2ia_setBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;text-transform:lowercase;background:0 0;border:0;padding:0;font-size:11px}.FYW2ia_setBtn:hover{text-decoration:underline}.FYW2ia_fetchedAt{opacity:.6}.FYW2ia_refreshBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}.FYW2ia_refreshBtn:hover{text-decoration:underline}.FYW2ia_setPanel{flex-direction:column;gap:8px;min-width:260px;display:flex}.FYW2ia_field{flex-direction:column;gap:3px;display:flex}.FYW2ia_fieldLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.75;font-variant-numeric:tabular-nums;font-size:11px}.FYW2ia_fieldInput{box-sizing:border-box;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);width:100%;color:var(--dsh-color-text,inherit);font-variant-numeric:tabular-nums;border-radius:6px;outline:none;height:26px;padding:0 8px;font-size:12px}.FYW2ia_fieldInput:focus{border-color:var(--dsh-color-accent,#50a0ffb3)}.FYW2ia_setHint{opacity:.55;font-size:11px}.FYW2ia_errorText{color:var(--dsh-color-danger,#e5534b);white-space:normal;max-width:240px;font-size:11px}";
		...
		var ocgo_module_css_default = {
			"chip": "FYW2ia_chip",
			"chipCol": "FYW2ia_chipCol",
			"chipOpen": "FYW2ia_chipOpen",
			"colFoot": "FYW2ia_colFoot",
			"colHead": "FYW2ia_colHead",
			"details": "FYW2ia_details",
			"errorText": "FYW2ia_errorText",
			"fetchedAt": "FYW2ia_fetchedAt",
			"field": "FYW2ia_field",
			"fieldInput": "FYW2ia_fieldInput",
			"fieldLabel": "FYW2ia_fieldLabel",
			"foot": "FYW2ia_foot",
			"footRight": "FYW2ia_footRight",
			"iconBtns": "FYW2ia_iconBtns",
			"lockBtn": "FYW2ia_lockBtn",
			"refreshBtn": "FYW2ia_refreshBtn",
			"seg": "FYW2ia_seg",
			"segErr": "FYW2ia_segErr",
			"segOk": "FYW2ia_segOk",
			"segSep": "FYW2ia_segSep",
			"segWarn": "FYW2ia_segWarn",
			"setBtn": "FYW2ia_setBtn",
			"setHint": "FYW2ia_setHint",
			"setPanel": "FYW2ia_setPanel",
			"window": "FYW2ia_window",
			"windowLabel": "FYW2ia_windowLabel",
			"windowReset": "FYW2ia_windowReset",
			"windowValue": "FYW2ia_windowValue",
			"wrap": "FYW2ia_wrap"
		};
		//#endregion
		...
		*/
		function OcgoDockEntry(props) {
			...
			* ("col"). Toggled from the chip, persisted under "dsh.ocgoChip.layout". */
			...
			posRef.current = pos;
			/** Anchor of the chip on the input card, in height-independent terms:
			* `x` = chip left - card left, `gap` = card top - chip bottom. Storing the
			* gap (instead of a pixel y) keeps the resting place identical no matter how
			* tall the chip's own content is, so a remount, a session switch or a
			* layout toggle can no longer leave the chip floating in the wrong spot.
			* DOM-controlled (no re-render per frame); persisted under
			* "dsh.ocgoChip.anchor". */
			const anchorRef = (0, react.useRef)(null);
			if (anchorRef.current === null) try {
				const raw = window.localStorage.getItem("dsh.ocgoChip.anchor");
				if (raw !== null) {
					const p = JSON.parse(raw);
					if (typeof p.x === "number" && typeof p.gap === "number") anchorRef.current = {
						x: p.x,
						gap: p.gap
					};
				}
			} catch {}
			/** Horizontal offset carried over from the pre-anchor model, used only until
			* the first measurement can derive the real gap. */
			const legacyLeftRef = (0, react.useRef)(null);
			if (anchorRef.current === null && legacyLeftRef.current === null) try {
				const raw = window.localStorage.getItem("dsh.ocgoChip.offset");
				if (raw !== null) {
					const p = JSON.parse(raw);
					if (typeof p.x === "number") legacyLeftRef.current = p.x;
				}
			} catch {}
			...
			const saveAnchor = () => {
				try {
					window.localStorage.setItem("dsh.ocgoChip.anchor", JSON.stringify(anchorRef.current));
				} catch {}
			};
			/** Express the chip's current on-screen position as an anchor. */
			const captureAnchor = (card) => {
				...
				anchorRef.current = {
					...
					gap: Math.round(cardRect.top - wrapRect.bottom)
				};
				saveAnchor();
			};
			/** Resolve the chip's target viewport position and write it to the DOM.
			* The vertical anchor is the chip's BOTTOM edge against the card's TOP, so
			* the resting place survives the chip growing or shrinking (stacked layout,
			* the daily line appearing, an error state) and survives a remount. */
			const applyPosition = (wrap) => {
				...
				if (anchorRef.current === null) {
					const wrapRect = wrap.getBoundingClientRect();
					anchorRef.current = {
						x: legacyLeftRef.current ?? Math.round(wrapRect.left - cardRect.left),
						gap: Math.round(cardRect.top - wrapRect.bottom)
					};
					saveAnchor();
				}
				const anchor = anchorRef.current;
				const x = Math.round(cardRect.left + anchor.x);
				const y = Math.round(cardRect.top - anchor.gap - wrap.offsetHeight);
			...
			* hand position control over to the rAF follower below. */
			(0, react.useLayoutEffect)(() => {
				...
				legacyLeftRef.current = null;
				try {
					window.localStorage.removeItem("dsh.ocgoChip.pos");
					window.localStorage.removeItem("dsh.ocgoChip.offset");
				} catch {}
				if (posRef.current !== null) setPos(null);
				chipStyleRef.current = null;
				applyPosition(wrap);
			}, [visible]);
			/** Follow the input card every frame: the chip keeps the same horizontal
			* offset and the same gap above the card while the sidebar width changes,
			* the composer grows, or the page scrolls. Writes are skipped while the
