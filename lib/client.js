window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:C:\Users\leyang809\Desktop\工作区\.tmp-ocgo-update\src\client\ocgo.module.css.mjs
		const css = "._0fQbaW_wrap{z-index:50;user-select:none;display:inline-flex;position:absolute;bottom:calc(100% - 1px);left:-9px}._0fQbaW_segOk{color:var(--dsh-color-success,#3fb950)}._0fQbaW_chip{background:var(--dsh-color-surface,transparent);height:22px;color:var(--dsh-color-text,inherit);cursor:grab;white-space:nowrap;user-select:none;border:0;border-radius:999px;align-items:center;gap:6px;padding:0 8px;font-size:12px;line-height:1;display:inline-flex}._0fQbaW_chip:hover,._0fQbaW_chipOpen{border-color:var(--dsh-color-accent,#50a0ffb3)}._0fQbaW_lockBtn{cursor:pointer;color:var(--dsh-color-accent,#50a0ffe6);white-space:nowrap;background:0 0;border:0;align-items:center;margin-left:4px;padding:0 2px;font-size:11px;line-height:1;display:inline-flex}._0fQbaW_seg{align-items:baseline;gap:3px;display:inline-flex}._0fQbaW_segSep{opacity:.45}._0fQbaW_segWarn{color:var(--dsh-color-warning,#d29922)}._0fQbaW_segErr{color:var(--dsh-color-danger,#e5534b)}._0fQbaW_details{z-index:40;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface-elevated,#1f1f1f);min-width:220px;color:var(--dsh-color-text,inherit);border-radius:8px;flex-direction:column;gap:6px;padding:8px 10px;font-size:12px;display:flex;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%);box-shadow:0 4px 12px #0000004d}._0fQbaW_window{justify-content:space-between;align-items:center;gap:12px;display:flex}._0fQbaW_windowLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.9;align-items:center;gap:6px;display:inline-flex}._0fQbaW_windowValue{font-variant-numeric:tabular-nums;align-items:baseline;gap:6px;display:inline-flex}._0fQbaW_windowReset{opacity:.65;font-variant-numeric:tabular-nums;font-size:11px}._0fQbaW_foot{border-top:1px solid var(--dsh-color-border,#80808040);justify-content:space-between;align-items:center;gap:8px;padding-top:6px;font-size:11px;display:flex}._0fQbaW_footRight{align-items:center;gap:8px;margin-left:auto;display:inline-flex}._0fQbaW_setBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;text-transform:lowercase;background:0 0;border:0;padding:0;font-size:11px}._0fQbaW_setBtn:hover{text-decoration:underline}._0fQbaW_fetchedAt{opacity:.6}._0fQbaW_refreshBtn{color:var(--dsh-color-accent,#50a0ffe6);cursor:pointer;background:0 0;border:0;padding:0;font-size:11px}._0fQbaW_refreshBtn:hover{text-decoration:underline}._0fQbaW_setPanel{flex-direction:column;gap:8px;min-width:260px;display:flex}._0fQbaW_field{flex-direction:column;gap:3px;display:flex}._0fQbaW_fieldLabel{color:var(--dsh-color-text-secondary,inherit);opacity:.75;font-variant-numeric:tabular-nums;font-size:11px}._0fQbaW_fieldInput{box-sizing:border-box;border:1px solid var(--dsh-color-border,#80808059);background:var(--dsh-color-surface,transparent);width:100%;color:var(--dsh-color-text,inherit);font-variant-numeric:tabular-nums;border-radius:6px;outline:none;height:26px;padding:0 8px;font-size:12px}._0fQbaW_fieldInput:focus{border-color:var(--dsh-color-accent,#50a0ffb3)}._0fQbaW_setHint{opacity:.55;font-size:11px}._0fQbaW_errorText{color:var(--dsh-color-danger,#e5534b);white-space:normal;max-width:240px;font-size:11px}";
		...
		var ocgo_module_css_default = {
			"chip": "_0fQbaW_chip",
			"chipOpen": "_0fQbaW_chipOpen",
			"details": "_0fQbaW_details",
			"errorText": "_0fQbaW_errorText",
			"fetchedAt": "_0fQbaW_fetchedAt",
			"field": "_0fQbaW_field",
			"fieldInput": "_0fQbaW_fieldInput",
			"fieldLabel": "_0fQbaW_fieldLabel",
			"foot": "_0fQbaW_foot",
			"footRight": "_0fQbaW_footRight",
			"lockBtn": "_0fQbaW_lockBtn",
			"refreshBtn": "_0fQbaW_refreshBtn",
			"seg": "_0fQbaW_seg",
			"segErr": "_0fQbaW_segErr",
			"segOk": "_0fQbaW_segOk",
			"segSep": "_0fQbaW_segSep",
			"segWarn": "_0fQbaW_segWarn",
			"setBtn": "_0fQbaW_setBtn",
			"setHint": "_0fQbaW_setHint",
			"setPanel": "_0fQbaW_setPanel",
			"window": "_0fQbaW_window",
			"windowLabel": "_0fQbaW_windowLabel",
			"windowReset": "_0fQbaW_windowReset",
			"windowValue": "_0fQbaW_windowValue",
			"wrap": "_0fQbaW_wrap"
		};
		//#endregion
